...
import {
  createUser, getUserByEmail, getUnreadNotifications, getUserBalance, markNotificationAsRead
...
const clientId = "BISrhkqtCXtec89-2cpucSLDnx5Gryg_TZs2fmUB5tM2z5e9qyq6CnOk40r4EMXyshp4fvMqDezljKzdCSGq_bM";
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">Smart Cleaning Management System</span>
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">AI Waste Management System</span>
            </div>
          </Link>
        </div>
